...
public class MakeRequestActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    seperate= findViewById(R.id.spinner);
    submit_button=findViewById(R.id.sumbit_button);
    chooseImageText = findViewById(R.id.choose_text);
    postImage = findViewById(R.id.post_image);
    ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(MakeRequestActivity.this, android.R.layout.simple_list_item_1,getResources().getStringArray(R.array.names));
    myAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    seperate.setAdapter(myAdapter);

    submit_button.setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View view) {
        if (isValid()) {
          String descri,seperator;
          descri=messageText.getText().toString();
          seperator=seperate.getSelectedItem().toString();
          uploadRequest(descri,seperator);
        }
      }
    });
  ...
  private void uploadRequest(String message, String seperator) {
    ...
    AndroidNetworking.upload(Endpoints.upload_request)
        ...
        .addQueryParameter("seperation", seperator)
