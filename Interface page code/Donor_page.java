...
public class Donor_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        make_request_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Donor_page.this, MakeRequestActivity.class));
            }
        });
        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if (item.getItemId() == R.id.search_button) {
                    //open search
                    startActivity(new Intent(Donor_page.this, SearchActivity.class));
                }
                return false;
            }
        });
    ...
    private void populateHomePage() {
        ...
        StringRequest stringRequest = new StringRequest(
                Request.Method.POST, Endpoints.donor, new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Donor_page.this, "Something went wrong:(", Toast.LENGTH_SHORT).show();
